...
function deletePost() {
    ...
    if (confirmed) {
        ...
        form.method = "post"; 
        form.action = "DeleteProcess3.jsp"; 
...
<body>
	...
	<input type="hidden" name="num" value="<%= num %>" />  
	    <table class="table table-bordered border-secondary" border="1" width="90%">
	        <tr>
...
<!-- 					*/ -->
	                ...
	                <button type="button" class="btn btn-success" onclick="location.href='MemberBoard.jsp?searchWord=<%= dto.getId() %>&searchField=id';">
	                    목록 보기
	                </button>
	            </td>
	        </tr>
