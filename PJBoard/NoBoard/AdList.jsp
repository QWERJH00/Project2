...
%>
        <tr align="center">
            ...
            <!-- 제목 -->  
            <td align="left"> 
                <a class="nav-link active" aria-current="page"  href="NoView.jsp?num=<%= dto.getNum() %>">
                <strong style='color: red;'>[공지사항]&nbsp&nbsp</strong><%= dto.getTitle() %></a> 
</a>
            </td>
            <!-- 작성자 아이디 -->
...
%>
    ...
    <table class="table table-borderless" border="0" width="90%" class="btn-group me-2" role="group" aria-label="Second group">
        <tr align="right">
        	<td align="center">
        	<td align="center" style="padding-left: 42px;">
